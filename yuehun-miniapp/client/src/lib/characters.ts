...
export const characters: Character[] = [
  {
    ...
    role: "谋士 / 太学博士",
    gender: "男",
    image: `${CHARACTER_IMAGE_BASE}xie-yunzhi-nobg.webp`,
    poem: "泠泠七弦上，静听松风寒。",
    poemAuthor: "刘长卿《听弹琴》",
  ...
  },
  {
    ...
    role: "将门女将",
    gender: "女",
    image: `${CHARACTER_IMAGE_BASE}xue-zhenyue-nobg.webp`,
  ...
  },
  {
    ...
    role: "治愈者",
    gender: "男",
    image: `${CHARACTER_IMAGE_BASE}ruan-ling-nobg.webp`,
    poem: "掩抑复凄清，非琴不是筝。",
  ...
  },
  {
    ...
    role: "草原少年",
    gender: "男",
    image: `${CHARACTER_IMAGE_BASE}maile-nobg.webp`,
    poem: "胡姬貌如花，当垆笑春风。",
  ...
  },
  {
    ...
    role: "侠盗",
    gender: "男",
    image: `${CHARACTER_IMAGE_BASE}su-mingyou-nobg.webp`,
    poem: "千山鸟飞绝，万径人踪灭。",
    poemAuthor: "柳宗元《江雪》",
  ...
  },
  {
    ...
    role: "情报掌控者",
    gender: "女",
    image: `${CHARACTER_IMAGE_BASE}liu-yaocong-nobg.webp`,
